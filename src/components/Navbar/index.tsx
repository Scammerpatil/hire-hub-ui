...
import { IconBriefcase, IconMenu } from "@tabler/icons-react";
  ...
  return (
    <>
      <motion.div
        ...
        className="navbar bg-base-100 shadow-sm fixed top-0 left-0 right-0 z-50 backdrop-blur-md border-b border-base-content lg:px-10"
      >
        ...
        <div className="navbar-end space-x-2">
          ...
          >
            <Link className="btn btn-outline btn-accent" href="/signup">
              Get Started
            </Link>
          </motion.div>
