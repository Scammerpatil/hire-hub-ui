...
export default function ManageEmployees() {
  ...
  return (
    <div className="pb-10">
                ...
                filteredEmployees.map((emp) => (
                  ...
                  >
                    ...
                    <td>
                      ...
                      <div className="text-xs opacity-50">{emp.user.phone}</div>
                    </td>
      ...
      {/* ADD EMPLOYEE MODAL */}
      <dialog id="add_employee" className="modal modal-bottom sm:modal-middle">
                ...
                <div className="join w-full">
                  <input
                    ...
                    onChange={(e) =>
                      setNewEmployee({
                        ...newEmployee,
                        user: { ...newEmployee.user, password: e.target.value },
                      })
                    }
                    required
                  />
